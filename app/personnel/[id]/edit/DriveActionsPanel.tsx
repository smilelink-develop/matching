    ...
    <>
      {driveFolderUrl ? (
        <a
          ...
          rel="noreferrer"
          title="保管場所を開く"
          className="flex h-10 w-10 items-center justify-center rounded-xl text-[var(--color-primary)] transition-transform hover:scale-110 hover:bg-[var(--color-light)]"
        >
          <FolderIcon />
        </a>
      ) : (
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-xl border border-dashed border-gray-300 text-gray-400 transition-transform hover:scale-110 hover:text-[var(--color-primary)]"
        >
          <FolderIcon />
        </button>
      )}
