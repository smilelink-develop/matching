    ...
    <PortalFrame person={person}>
      <div className="space-y-4">
        <section className="rounded-[28px] border border-white/80 bg-white/90 p-5 shadow-[0_14px_38px_rgba(15,23,42,0.08)]">
          <p className="text-sm font-semibold text-[#0F172A]">今回の依頼</p>
        ...
        <section className="space-y-3">
          {SLOTS.map((slot, index) => (
            ...
            >
              <p className="text-base font-semibold text-[#0F172A]">{slot}</p>
        ...
        <section className="rounded-[28px] border border-white/80 bg-white/90 p-5 shadow-[0_14px_38px_rgba(15,23,42,0.08)]">
          <p className="text-sm font-semibold text-[#0F172A]">別日程を希望する場合</p>
          <textarea
            className="mt-3 min-h-28 w-full rounded-2xl border border-[#D6E4FF] bg-[#F8FBFF] px-4 py-3 text-sm text-[#334155] outline-none"
            defaultValue="午前中が難しいため、午後の候補日を希望します。"
          />
          <button className="mt-4 w-full rounded-2xl bg-[#2563EB] px-4 py-3 text-sm font-medium text-white shadow-[0_12px_24px_rgba(37,99,235,0.2)]">
            希望を送信する
          </button>
        </section>
      </div>
